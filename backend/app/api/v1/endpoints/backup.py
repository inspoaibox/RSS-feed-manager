        ...
        "custom_rules": [
            {
                ...
                "proxy_enabled": getattr(r, "proxy_enabled", False),
                "proxy_url": getattr(r, "proxy_url", None),
                "proxy_mode": getattr(
                    r,
                    "proxy_mode",
                    "single" if getattr(r, "proxy_enabled", False) else "none",
                ),
                "proxy_pool_country": getattr(r, "proxy_pool_country", None),
                "proxy_pool_protocol": getattr(r, "proxy_pool_protocol", None),
                ...
                "translate_title": getattr(r, "translate_title", True),
                "translate_content": getattr(r, "translate_content", False),
        ...
        "keyword_subscriptions": [
            {
                ...
                "excluded_category_ids": list(getattr(item, "excluded_category_ids", []) or []),
                "excluded_feed_ids": list(getattr(item, "excluded_feed_ids", []) or []),
    ...
    for rule_data in data.get("custom_rules", []):
        ...
        try:
            ...
            values = {
                ...
                "proxy_enabled": rule_data.get("proxy_enabled", False),
                "proxy_url": rule_data.get("proxy_url") if rule_data.get("proxy_enabled", False) else None,
                "proxy_mode": rule_data.get(
                    "proxy_mode",
                    "single" if rule_data.get("proxy_enabled", False) else "none",
                ),
                "proxy_pool_country": rule_data.get("proxy_pool_country"),
                "proxy_pool_protocol": rule_data.get("proxy_pool_protocol"),
                ...
                "translate_title": rule_data.get("translate_title", True),
                "translate_content": rule_data.get("translate_content", False),
    ...
    for item_data in data.get("keyword_subscriptions", []):
        ...
        try:
            ...
            values = {
                ...
                "excluded_category_ids": list(item_data.get("excluded_category_ids") or []),
                "excluded_feed_ids": list(item_data.get("excluded_feed_ids") or []),
